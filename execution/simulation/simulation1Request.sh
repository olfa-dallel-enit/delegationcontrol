...
delegationcontrold query fdpd list-final-delegation-decision --node tcp://localhost:26657 > execution/simulation/final-delegation-decision-1request.txt


sleep 30

delegationcontrold query fdpd list-calculation-time --node tcp://localhost:26657 > execution/simulation/calculation-time-1request.txt
