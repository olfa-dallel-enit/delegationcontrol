...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.FdpdPacketData
	...
	case *types.FdpdPacketData_EstablishCooperationPacket:
	...
	case *types.FdpdPacketData_RequestDelegationPacket:
		packetAck, err := am.keeper.OnRecvRequestDelegationPacket(ctx, modulePacket, *packet.RequestDelegationPacket)
		if err != nil {
			ack = channeltypes.NewErrorAcknowledgement(err.Error())
		} else {
			// Encode packet acknowledgment
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeRequestDelegationPacket,
				sdk.NewAttribute(sdk.AttributeKeyModule, types.ModuleName),
				sdk.NewAttribute(types.AttributeKeyAckSuccess, fmt.Sprintf("%t", err != nil)),
			),
		)
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.FdpdPacketData_RequestDelegationPacket:
		err := am.keeper.OnAcknowledgementRequestDelegationPacket(ctx, modulePacket, *packet.RequestDelegationPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeRequestDelegationPacket
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.FdpdPacketData_RequestDelegationPacket:
		err := am.keeper.OnTimeoutRequestDelegationPacket(ctx, modulePacket, *packet.RequestDelegationPacket)
		if err != nil {
			return err
		}
