...
import DelegationcontrolDelegationcontrolFdpd from './delegationcontrol/delegationcontrol.fdpd'
...
export default { 
  ...
  DelegationcontrolDelegationcontrolFdpd: load(DelegationcontrolDelegationcontrolFdpd, 'delegationcontrol.fdpd'),
