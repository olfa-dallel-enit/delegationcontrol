...
export interface FinalDelegationDecision {
  id: number;
...
const baseFinalDelegationDecision: object = {
  id: 0,
...
export const FinalDelegationDecision = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): FinalDelegationDecision {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseFinalDelegationDecision,
    } as FinalDelegationDecision;
  ...
  fromJSON(object: any): FinalDelegationDecision {
    const message = {
      ...baseFinalDelegationDecision,
    } as FinalDelegationDecision;
  ...
  toJSON(message: FinalDelegationDecision): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<FinalDelegationDecision>
